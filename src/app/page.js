...
export default function Home() {
  ...
  return (
    <div className="bg-[#EEF0F2] lg:ml-[70px] lg:rounded-ss-3xl pt-3 pl-4 pr-4 sm:pr-4 lg:flex gap-4 justify-between relative pb-20 lg:pb-0">
      ...
      {/* for mobile Mainbar */}
      <>
        <div onClick={(e) =>  setIsMainBarOpen(false)} className={`bg-[#101010bb] w-screen h-screen absolute z-0 lg:hidden duration-500 rounded-s-3xl ${isMainBarOpen ? "top-0 left-0" : "top-0 -left-[1100px]"}`}>
